...
//        overridePendingTransition(R.anim.abc_fade_in,R.anim.abc_fade_out);
        ...
        buttonlostFound = (Button) findViewById(R.id.button_choose_image);
...
//        buttonCamera.setOnClickListener(this);
    ...
    private void cameraUpload(final String path) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(lostFound.this, "Upload failed", Toast.LENGTH_LONG).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(lostFound.this, "Upload successful", Toast.LENGTH_LONG).show();
            ...
            uploadTask = fileReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(lostFound.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Picasso.get().load(imageUri).resize(500,500).into(imageView);
        }
