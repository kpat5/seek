...
//
//public class lost_found_post extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_lost_found_post);
//    }
//}
...
import com.example.seek.Post;
import com.example.seek.Upload;
import com.example.seek.User;
...
public class lost_found_post extends AppCompatActivity implements View.OnClickListener {
    ...
    private void cameraUpload(final String path) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(lost_found_post.this, "Upload failed", Toast.LENGTH_LONG).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(lost_found_post.this, "Upload successful", Toast.LENGTH_LONG).show();
            ...
            uploadTask = fileReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(lost_found_post.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
